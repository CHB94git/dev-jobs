                ...
                @auth
                    ...
                    @can('create', App\Models\Vacant::class)
                        ...
                        <a href="{{ route('notifications') }}"
                            class="mr-3 w-7 h-7 rounded-full bg-teal-600 hover:bg-teal-800 flex flex-col justify-center items-center text-sm font-extrabold text-white">
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if (Auth::user()->role === 2)
                    <div class="flex gap-2 items-center p-3">
                        <a href="{{ route('notifications') }}"
                            class="w-7 h-7 rounded-full bg-teal-600 hover:bg-teal-800 flex flex-col justify-center items-center text-sm font-extrabold text-white">
                            {{ Auth::user()->unreadNotifications->count() }}
                        </a>
